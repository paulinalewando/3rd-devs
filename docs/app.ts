...
const { docs } = await fileService.process(
  "https://cloud.overment.com/S04E03-1732688101.md",
  5000 // Add chunk size to avoid Algolia's 10KB limit
);
...
// // // TRANSLATION
const translatedDocs = await documentService.translate(
  docs,
  "Polish",
  "English"
);
